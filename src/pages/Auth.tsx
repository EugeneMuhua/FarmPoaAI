...
const Auth = () => {
  ...
  const [role, setRole] = useState<'farmer' | 'buyer' | 'specialist'>('buyer');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 to-secondary/5 p-4">
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-center">
        <div className="hidden md:block">
          <img
            src={kenyanFarmerImage}
            alt="Kenyan farmer using FarmPoa AI"
        ...
        <Card className="w-full max-w-md mx-auto">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-primary">FarmPoa AI</CardTitle>
              ...
              <TabsContent value="signup" className="space-y-4">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={role} onValueChange={(value: 'farmer' | 'buyer' | 'specialist') => setRole(value)}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        ...
                        <SelectItem value="specialist">Specialist (Agrovet/Expert)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
